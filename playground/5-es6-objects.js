...
const transaction = (type, { label, price, any }) => {
    ...
    //    the same
    // 3. The results of calling transaction would give you 'Red notebook, 3, undefined' | any is not a property
    //    in product and therefore is not defined. when an object is passed as an argument, the properties must 
    //    exist within the object
}

transaction('order', product)

// TL:DR you can pass an object as an argument and get the objects properties directly without dot notation